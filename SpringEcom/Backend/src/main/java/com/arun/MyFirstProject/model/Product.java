package com.arun.MyFirstProject.model;
...
public class Product {
	...
	public Product(int id, String name, String description, String brand, BigDecimal price, String category,
			Date releaseDate, boolean available, int stockQuantity, boolean productAvailable, String imageName,
	...
	public String toString() {
		return "Product [id=" + id + ", name=" + name + ", description=" + description + ", brand=" + brand + ", price="
				...
				+ ", stockQuantity=" + stockQuantity + ", productAvailable=" + productAvailable + ", imageName="
